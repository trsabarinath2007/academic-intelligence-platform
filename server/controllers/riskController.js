...
const calculateStudentRisk = async (student) => {
...
const getStudentRisk = async (req, res) => {
  try {
    ...
    const result = await calculateStudentRisk(student);
...
// ==========================================
// FACULTY / ADMIN - GET RISK OF A STUDENT
// ==========================================

const getStudentRiskById = async (req, res) => {
  try {
